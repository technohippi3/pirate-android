...
internal val PROFILE_GENDER_OPTIONS = listOf(
...
internal val PROFILE_RELOCATE_OPTIONS = listOf(
  ProfileEnumOption(0, "Not specified"),
...
internal val PROFILE_DEGREE_OPTIONS = listOf(
  ProfileEnumOption(0, "Not specified"),
...
internal val PROFILE_FIELD_OPTIONS = listOf(
  ProfileEnumOption(0, "Not specified"),
...
internal val PROFILE_PROFESSION_OPTIONS = listOf(
  ProfileEnumOption(0, "Not specified"),
...
internal val PROFILE_INDUSTRY_OPTIONS = listOf(
  ProfileEnumOption(0, "Not specified"),
...
internal val PROFILE_RELATIONSHIP_OPTIONS = listOf(
  ProfileEnumOption(0, "Not specified"),
...
internal val PROFILE_SEXUALITY_OPTIONS = listOf(
  ProfileEnumOption(0, "Not specified"),
...
internal val PROFILE_ETHNICITY_OPTIONS = listOf(
  ProfileEnumOption(0, "Not specified"),
...
internal val PROFILE_DATING_STYLE_OPTIONS = listOf(
  ProfileEnumOption(0, "Not specified"),
...
internal val PROFILE_CHILDREN_OPTIONS = listOf(
  ProfileEnumOption(0, "Not specified"),
  ProfileEnumOption(1, "None"),
  ProfileEnumOption(2, "Has children"),
)

internal val PROFILE_WANTS_CHILDREN_OPTIONS = listOf(
  ProfileEnumOption(0, "Not specified"),
  ProfileEnumOption(1, "No"),
...
internal val PROFILE_DRINKING_OPTIONS = listOf(
  ProfileEnumOption(0, "Not specified"),
...
internal val PROFILE_SMOKING_OPTIONS = listOf(
  ProfileEnumOption(0, "Not specified"),
  ProfileEnumOption(1, "No"),
...
internal val PROFILE_DRUGS_OPTIONS = listOf(
  ProfileEnumOption(0, "Not specified"),
  ProfileEnumOption(1, "Never"),
...
internal val PROFILE_LOOKING_FOR_OPTIONS = listOf(
  ProfileEnumOption(0, "Not specified"),
...
internal val PROFILE_RELIGION_OPTIONS = listOf(
  ProfileEnumOption(0, "Not specified"),
...
internal val PROFILE_PETS_OPTIONS = listOf(
  ProfileEnumOption(0, "Not specified"),
...
internal val PROFILE_DIET_OPTIONS = listOf(
  ProfileEnumOption(0, "Not specified"),
