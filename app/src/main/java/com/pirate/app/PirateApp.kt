...
fun PirateApp(activity: androidx.fragment.app.FragmentActivity) {
  ...
  val player = remember {
    PlayerController(appContext).also {
      com.pirate.app.widget.NowPlayingWidgetActionReceiver.playerRef = it
    }
  }
