    ...
    TempoSessionKeyApi.authorizeSessionKey(
      ...
      onProgress = { stage ->
        val status = when (stage) {
          com.pirate.app.tempo.SessionKeyAuthorizationProgress.SIGNATURE_1 -> SessionSetupStatus.SIGNATURE_1
          com.pirate.app.tempo.SessionKeyAuthorizationProgress.SIGNATURE_2 -> SessionSetupStatus.SIGNATURE_2
          com.pirate.app.tempo.SessionKeyAuthorizationProgress.FINALIZING -> SessionSetupStatus.FINALIZING
        }
