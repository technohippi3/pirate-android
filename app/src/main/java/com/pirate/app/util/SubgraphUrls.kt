...
private const val DEFAULT_SUBGRAPH_MUSIC_SOCIAL_URL =
  "$GOLDSKY_SUBGRAPH_BASE_URL/music-social-tempo/latest/gn"

private const val DEFAULT_SUBGRAPH_PROFILES_URL =
  "$GOLDSKY_SUBGRAPH_BASE_URL/profiles-tempo/latest/gn"

private const val DEFAULT_SUBGRAPH_PLAYLISTS_URL =
  "$GOLDSKY_SUBGRAPH_BASE_URL/playlist-feed-tempo/latest/gn"

private const val DEFAULT_SUBGRAPH_STUDY_PROGRESS_URL =
  "$GOLDSKY_SUBGRAPH_BASE_URL/study-progress-tempo/latest/gn"

private const val DEFAULT_SUBGRAPH_FEED_URL =
  "$GOLDSKY_SUBGRAPH_BASE_URL/tiktok-feed-tempo/latest/gn"
